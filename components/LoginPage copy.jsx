...
import { User, Lock, Loader2, ArrowLeft, AlertCircle, LayoutDashboard, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-950 p-6 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="w-full max-w-md bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 dark:border-gray-800 p-8 relative z-10 animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="flex flex-col items-center mb-8 pt-4">
           <div className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 p-3 rounded-2xl shadow-lg mb-3">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-gray-400">Enter your username to access your home</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center justify-between text-sm">
             <label className="flex items-center gap-2 text-gray-500 dark:text-gray-400 cursor-pointer group">
               ...
               />
               <span className="group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors">Remember me</span>
             </label>
        ...
        <p className="text-center mt-8 text-sm text-gray-500 dark:text-gray-400">
          Don't have an account? <button className="text-blue-600 dark:text-blue-400 font-bold hover:underline">Create Account</button>
        </p>
      </div>
    </div>
  );
